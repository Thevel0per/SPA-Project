...
var flashcardsManager = {
  ...
  translate: (language, targetLanguage, word, callback) => {
    ...
    let URL =
      "https://systran-systran-platform-for-language-processing-v1.p.rapidapi.com/translation/text/translate?source=" +
      language +
      "&target=" +
      targetLanguage +
      "&input=" +
    ...
    xhr.setRequestHeader(
      "x-rapidapi-key",
      "482cdac65emsh8666d06d1f83e34p1def36jsn80007fcad40b"
    );
